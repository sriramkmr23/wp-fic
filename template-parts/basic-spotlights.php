<?php if( get_sub_field( 'basic-spotlights-include' ) == 'yes' ) :?>

<!-- Start Basic Spotlights -->
<section class="mb-6xx basic-spotlights">
    <div class="container">

        <div class="row">

            <?php if(have_rows('basic-spotlights-items')):?>

                <?php while(have_rows('basic-spotlights-items')): the_row(); ?>

                    <div class="col-md-4 py-3 text-left basic-spotlights-item">
