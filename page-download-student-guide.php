         ...
         <div class="col-md-9">
            ...
            <section class="application-form content">
               <div class="container">
                  <div class="row">
                     <div class="col">
                        <form id="mktoForm_10880" class="form2"></form>
...
<script>
   MktoForms2.loadForm("//au-sn01.marketo.com", "837-CGY-335", 10880, function(form) {
   	$('select').change(function() {
   		$("#mktoForm_10880").find("*").attr("style", "");
   		$("#mktoForm_10880").attr("style", "");
   	...
   	form.onSuccess(function(values, followUpUrl) {
   		...
   		location.href = "/future-students/download-student-guide-thank-you/";
